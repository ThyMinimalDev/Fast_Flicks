...
export default async function Disclaimers() {
  return (
    <main>
      <div
        className={cn(
      ...
      >
        ...
        <ul>
          ...
          <li>
            <strong>Website</strong> refers to Fast_Flicks, accessible from{' '}
            <a
              href="https://fast-flicks.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://fast-flicks.com
            </a>
          </li>
        </ul>
        <h1>Disclaimer</h1>
        ...
        <p>
          ...
          Service at any time without prior notice. This Disclaimer has been created with
          the help of the{' '}
        ...
        <ul>
          <li>By email: info@fast-flicks.com</li>
        </ul>
      </div>
    </main>
  )
